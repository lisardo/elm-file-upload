...
var _user$project$Main$viewImagePreview = function (image) {
	return A2(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'ImageSelected') {
			...
			var _p1 = _p0._0;
			var newImage = {contents: _p1.contents, filename: _p1.filename};
			return {
				ctor: '_Tuple2',
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {id: 'ImageInputId', mImage: _elm_lang$core$Maybe$Nothing},
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {id: a, mImage: b};
	});
var _user$project$Main$ImageRead = function (a) {
	return {ctor: 'ImageRead', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Ports$fileContentRead(_user$project$Main$ImageRead);
};
var _user$project$Main$ImageSelected = {ctor: 'ImageSelected'};
var _user$project$Main$view = function (model) {
	var imagePreview = function () {
		var _p2 = model.mImage;
		if (_p2.ctor === 'Just') {
			return _user$project$Main$viewImagePreview(_p2._0);
		} else {
